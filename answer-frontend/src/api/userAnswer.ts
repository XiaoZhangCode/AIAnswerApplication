...
/** 分页获取我的答题记录列表 GET /user-answer/myPage */
export async function getUserMyAnswerPage(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getUserMyAnswerPageParams,
  options?: { [key: string]: any },
) {
  return request<API.CommonResultPageResultUserAnswerVo>('/user-answer/myPage', {
    method: 'GET',
    params: {
      ...params,
