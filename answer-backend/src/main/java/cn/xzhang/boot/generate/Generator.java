...
public class Generator {
    ...
    static String url = "jdbc:mysql://localhost:3306/ai_answer?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=Asia/Shanghai";
    ...
    public static void main(String[] args) {
        ...
        // 文件头描述
        String description = "评分结果";
        // 实体类的表名 大写
        String tableName = "UserAnswer";
        // 生成的文件目录
